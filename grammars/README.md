...
| `tree-sitter-php.wasm` | PHP (`.php`, `.phtml`) | `walkers/php.ts` |
| `tree-sitter-kotlin.wasm` | Kotlin (`.kt`, `.kts`) | `walkers/kotlin.ts` |
| `tree-sitter-swift.wasm` | Swift (`.swift`) | `walkers/swift.ts` |
