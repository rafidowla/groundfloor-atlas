...
/**
 * CodeSymbol — A code element parsed from a source repository.
 * Represents a function, class, method, interface, or other structural
 * code element with its location and relationships. Indexed by Groundfloor Atlas
 * (the in-house tree-sitter parser + cross-file resolver).
 */
